...
/*****************
 * HOTSPOT FRACTIONS (your final aligned values)
 * x,y,w,h are fractions of the ORIGINAL image (0..1).
 *****************/
const HS = {
  tokenomics: { el: hsTokenomics, x: 0.2,   y: 0.647, w: 0.096, h: 0.036, skew: -7,  rot: -7   },
  contract:   { el: hsContract,   x: 0.481, y: 0.645, w: 0.102,h: 0.034, skew: -4,  rot: 5.2  },
  links:      { el: hsLinks,      x: 0.661, y: 0.671, w: 0.048,h: 0.029, skew: -5,  rot: 2.2  },
};
...
if (window.visualViewport) {
  window.visualViewport.addEventListener('resize', layoutCover);
  window.visualViewport.addEventListener('scroll', layoutCover);
}
